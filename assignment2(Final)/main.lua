...
function love.load()
    ...
    gFrames = {
        ...
        ['powerups'] = GenerateQuadsPowerups(gTextures['main'])--Update(I): sliced powerups(ball and key)
    }

    gFrames['bricks'][22] = love.graphics.newQuad(160, 48, 32,
    16, gTextures['main']:getDimensions())--Update(III): Added the "key brick" to bricks
    ...
    gSounds = {
        ...
        ['paddle-inc'] = love.audio.newSource('sounds/Short_and_Sweep.wav'),
        --Update(II):sfx for paddle increase(Whoop)
        ['unlock'] = love.audio.newSource('sounds/Unlock.wav'),
        --Update(III):sfx for key powerup
